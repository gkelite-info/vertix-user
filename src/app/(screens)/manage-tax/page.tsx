...
//   //       setData(clients)
//   //     } catch (error: any) {
//   //       toast.error(error?.message || "Failed to fetch user or clients")
//   //     } finally {
...
//   // 🆕 FIX 1: fetch user once and save in state
//   useEffect(() => {
...
//     try {
//       await updateSubStatus(row.customerId, value)
//       setData((prev) =>
//         prev.map((r) =>
//           r.customerId === row.customerId ? { ...r, sub_status: value } : r
//         )
//       )
...
//     try {
//       await updateAssignedUser(row.customerId, value)
//       setData((prev) =>
//         prev.map((r) =>
//           r.customerId === row.customerId ? { ...r, assigned: value } : r
//         )
//       )
...
//         return
//       }
//       const updatedBy = appUser?.name || userName
...
//     { name: "Client Id", render: (row) => row.referId },
//     {
//       name: "Status",
//       render: (row) => (
//         <select
