...
function Page() {
    ...
    const handleLogin = async () => {
        try {
            ...
            const res = await fetch("http://localhost:5000/api/v1/vertix/customer/login", { //change this route later
                method: "POST",
                    ...
                    <div className="bg-red-00 lg:w-[50%] lg:h-[100%] lg:p-4 flex flex-col items-center justify-end">
                        ...
                        <div className="bg-green-00 lg:h-[85%] lg:w-[95%] lg:p-3 flex flex-col items-center">
                            <div className="bg-pink-00 lg:h-[90%] lg:w-[80%] flex flex-col justify-center">
                                ...
                                {emailError && <p className="text-red-500 text-xs lg:mt-1">{emailError}</p>}
                                ...
                                {passwordError && <p className="text-red-500 text-xs lg:mt-1">{passwordError}</p>}
                                ...
                                <div className="bg-green-00 lg:h-[20%] flex flex-col lg:gap-2 lg:mt-8 items-center">
                                    <button className="text-white lg:h-[65%] lg:w-[100%] text-lg font-medium lg:rounded-full bg-[#1D2B48] cursor-pointer" onClick={dummy}>
                                        Login
                                    </button>
